...
type ProductCategory =
  import("../types/supabase").definitions["product_category"];
type ProductWithRelations = import("../types/supabase").definitions["product"] &
  ProductVariants;
type ProductPostBody = Omit<ProductWithRelations, "id">;
type CategoryPostBody = Omit<ProductCategory, "id" | "created_at">;
type ProductVariantPost = Omit<
...
type OrderItemWithRelations =
  import("../types/supabase").definitions["order_item"] & {
    product: import("../types/supabase").definitions["product"];
    product_variant: import("../types/supabase").definitions["product_variant"];
  };

type UserOrderWithRelations =
  import("../types/supabase").definitions["user_order"] & {
