import { Text, Group, Button, Mark } from '@mantine/core';
...
const OrderItem = (props: { orderItem: OrderItemWithRelations }) => {
    ...
    const { code: poduct_code, images, title, category: { category } } = product
                ...
                <div>
                    <Button compact target="_blank" component="a" style={{ padding: 0 }} href={productLink} variant="subtle">
                        <Text size="lg" weight={500} >
                            {title}&nbsp;<Text span inline size="md" color="dimmed">({sku})</Text>
                        </Text>
                    </Button>
